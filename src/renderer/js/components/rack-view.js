...
export class RackView {
  constructor(container, { hasWorklet } = {}) {
    this.container = container; this.hasWorklet = hasWorklet || (() => false); this.rackId = null; this.selected = null; this.pending = null
  ...
  render() {
    if (this.container.style.display === 'none' || !this.rackId) return
